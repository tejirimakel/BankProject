...
<article>
    ...
    <div>
        <p class="text-white">Sorry for the inconvenience. we&rsquo;ll be back up shortly!</p>
        <p class="text-white">&mdash; The City First Team</p>
        <div class="form-group mx-auto d-flex justify-content-center">
          <a href="index.php" class="theme-btn3">Go Back</a>
          </div>
    </div>
</article>